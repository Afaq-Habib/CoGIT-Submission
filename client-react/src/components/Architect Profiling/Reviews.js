  ...
  render() {
    return (
      <Wrapper>
        ...
        <Box component="fieldset" mb={3} borderColor="transparent" boxShadow="0px 10px #505050">
        <Typography style={{fontSize:14}} component="legend">By {"Afaq"}</Typography>
        <Rating name="read-only" value={4} readOnly />
        <div>My name is Afaq</div>
      </Box>
      <br />
      <Box component="fieldset" mb={3} borderColor="transparent" boxShadow="0px 10px #505050">
        <Typography style={{fontSize:14}} component="legend">By {"Ahmad"}</Typography>
        <Rating name="read-only" value={3} readOnly />
        <div>My name is Ahmad</div>
      </Box>
      <br />
      <Box component="fieldset" mb={3} borderColor="transparent" boxShadow="0px 10px #505050">
        <Typography style={{fontSize:14}} component="legend">By {"Ali"}</Typography>
        <Rating name="read-only" value={3} readOnly />
